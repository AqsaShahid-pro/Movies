...
const App = () => {
  ...
  const fetchMovies = async (query = '') => {
    ...
    try {
      ...
      if (data.Response == 'False') {
        setErrorMessage(data.Error || 'Failed to fetch result');
        setMoviesList([]);
        return;
      }
      ...
      setErrorMessage('Error fecthing the movies');
    }
    finally {
      setLoading(false);
    }
  ...
  const loadTrendingMovies = async () => {
    try {
      ...
      //commented above line beacuse it  would break the application as we
      //are checking error message below and not displaying movies if error message exists
    }
  }
